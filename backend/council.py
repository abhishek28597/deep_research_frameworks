...
Now provide your evaluation and ranking:"""
    ...
    responses = await query_models_parallel(COUNCIL_MODELS, messages, max_completion_tokens=2000)
...
Provide a clear, well-reasoned final answer that represents the council's collective wisdom:"""
    ...
    response = await query_model(CHAIRMAN_MODEL, messages, max_completion_tokens=4000)
